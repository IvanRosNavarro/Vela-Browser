...
export const darkTheme: Theme = {
  ...
  variables: {
    ...
    '--vela-bg-row-active': 'rgba(120, 140, 255, 0.16)',
    '--vela-bg-folder-hover': 'rgba(255, 255, 255, 0.04)',
    '--vela-fg-subtle': '#5a6070',
    '--vela-border-strong': 'rgba(255, 255, 255, 0.16)',
    '--vela-accent-soft': 'rgba(125, 140, 255, 0.18)',
    '--vela-accent-strong': '#9aa6ff',
    '--vela-folder-marker-default': '#4b5266',
    '--vela-drop-line': '#7d8cff',
    '--vela-drop-bg': 'rgba(125, 140, 255, 0.10)',
