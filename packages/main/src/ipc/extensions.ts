...
// Convierte un locale BCP 47 (ej: 'es-ES', 'es') a la lista de candidatos
// en formato _locales (guión bajo), del más al menos específico.
...
// Resuelve cadenas de localización tipo __MSG_key__ que Chrome i18n usa en los manifests.
// Prioriza el locale del sistema (app.getLocale()) con fallback a inglés.
function resolveI18nMessage(extPath: string, value: string | undefined): string {
  if (!value) return '';
