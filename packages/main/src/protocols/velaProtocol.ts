...
const ALLOWED_PAGES = ['settings', 'newtab', 'history', 'extensions', 'about', 'reader', 'filepicker', 'glance', 'media-popup', 'cookiepanel', 'zoom-popup', 'favorites', 'import-data', 'anchors', 'adblocker-panel', 'vault-save-modal', 'vault-autofill-modal', 'autofill-popup', 'autofill-save', 'passwords', 'scripts', 'security-popup', 'notification-permission', 'devmode-popup', 'devtools-eyedropper', 'suggestions-popup', 'nav-history-popup', 'workspace-dropdown', 'profile-dropdown', 'vela-menu', 'sidebar-floating', 'add-node-menu', 'downloads', 'download-popup', 'tab-preview', 'folder-view', 'analytics-debugger', 'tools-cluster', 'status-cluster', 'find-bar', 'cert-error', 'translate-result', 'translate-confirm', 'media-permission-popup', 'client-cert-select'] as const;
