...
export const IPC_CHANNELS = {
  ...
  TAB_MOVE_TO_WINDOW: 'tab:move-to-window',
  ...
  SYNC_LIST_ACCOUNT_PROFILES: 'sync:list-account-profiles',
  SYNC_ADOPT_REMOTE_PROFILE: 'sync:adopt-remote-profile',
  SYNC_SET_PROFILE_PAUSED: 'sync:set-profile-paused',
  ...
  WINDOW_OPEN_BLINDED: 'window:open-blinded',
